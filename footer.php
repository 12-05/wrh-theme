...
<div id="libertas-footer" style="background:#111"><div style="background:#222;padding:20px;padding-top:40px;display:flex;justify-content:center"><a href="https://www.libertashotels.com" target="_blank" rel="noopener noreferrer"><img src="https://libertas-api.12-05.com/wp-content/uploads/2024/07/footer_logo.svg" alt="Logo"></a></div><div style="height:40px;border-left:50vw solid transparent;border-right:50vw solid transparent;border-top:20px solid #222"></div><div style="background:#111"><div style="padding:32px;display:grid;grid-template-columns:repeat(auto-fill, minmax(280px, 1fr));gap:16px;margin:0 auto;max-width:1200px"><a target="_blank" href="https://hotel-germania.at/" style="width:100%;padding:16px;display:flex;justify-content:flex-end;flex-direction:column;height:240px;border-radius:4px;overflow:hidden;position:relative;text-decoration:none"><div style="position:absolute;height:100%;width:100%;top:0;left:0;z-index:2;background:rgba(0, 0, 0, 0)
      ...
      0% 0% no-repeat padding-box"></div><img style="position:absolute;height:100%;width:100%;top:0;object-fit:cover;left:0;transition:all 0.5s ease;z-index:1" src="https://libertas-api.12-05.com/wp-content/uploads/2024/07/bregenz.png" alt="Bregenz"><div style="position:relative;z-index:10"><div style="background-color: rgba(10,10,10,0.7);padding:10px; border-radius:5px"><div style="font-size:28px;text-transform:uppercase;font-weight:bold;color:white">Bregenz</div><div style="font-size:16px;color:rgb(255, 199, 125)">Germania</div></div></div></a><a target="_blank" href="https://latini.libertashotels.com" style="width:100%;padding:16px;display:flex;justify-content:flex-end;flex-direction:column;height:240px;border-radius:4px;overflow:hidden;position:relative;text-decoration:none"><div style="position:absolute;height:100%;width:100%;top:0;left:0;z-index:2;background:rgba(0, 0, 0, 0)
      linear-gradient(
        360deg,
        #1c1c1c 0%,
        rgba(28, 28, 28, 0.4) 45%,
      ...
      0% 0% no-repeat padding-box"></div><img style="position:absolute;height:100%;width:100%;top:0;object-fit:cover;left:0;transition:all 0.5s ease;z-index:1" src="https://libertas-api.12-05.com/wp-content/uploads/2024/07/kehl.png" alt="Kehl/Strassburg"><div style="position:relative;z-index:10"><div style="background-color: rgba(10,10,10,0.7);padding:10px; border-radius:5px"><div style="font-size:28px;text-transform:uppercase;font-weight:bold;color:white">Kehl/Strassburg</div><div style="font-size:16px;color:rgb(255, 199, 125)">Rebstock</div></div></div></a><a target="_blank" href="https://schuetthof.libertashotels.com/" style="width:100%;padding:16px;display:flex;justify-content:flex-end;flex-direction:column;height:240px;border-radius:4px;overflow:hidden;position:relative;text-decoration:none"><div style="position:absolute;height:100%;width:100%;top:0;left:0;z-index:2;background:rgba(0, 0, 0, 0)
      linear-gradient(
        360deg,
        #1c1c1c 0%,
        rgba(28, 28, 28, 0.4) 45%,
      ...
      0% 0% no-repeat padding-box"></div><img style="position:absolute;height:100%;width:100%;top:0;object-fit:cover;left:0;transition:all 0.5s ease;z-index:1" src="https://libertas-api.12-05.com/wp-content/uploads/2024/07/zell1.png" alt="Zell Am See"><div style="position:relative;z-index:10"><div style="background-color: rgba(10,10,10,0.7);padding:10px; border-radius:5px"><div style="font-size:28px;text-transform:uppercase;font-weight:bold;color:white">Zell Am See</div><div style="font-size:16px;color:rgb(255, 199, 125)">Schütthof</div></div></div></a><a target="_blank" href="https://www.theaterhotel-wien.at" style="width:100%;padding:16px;display:flex;justify-content:flex-end;flex-direction:column;height:240px;border-radius:4px;overflow:hidden;position:relative;text-decoration:none"><div style="position:absolute;height:100%;width:100%;top:0;left:0;z-index:2;background:rgba(0, 0, 0, 0)
      linear-gradient(
        360deg,
        #1c1c1c 0%,
        rgba(28, 28, 28, 0.4) 45%,
